...
```{r}
rm(list=setdiff(ls(), c("line3")))

### add a line to remove all variables except line2

#Sampling & cleaning

news <- line3[435506:1025542]
...
myCorpus <- corpus(news) # news originally
...
saveRDS(fivegram_split_df, file="fiveblogsamp_twitter_2.rds", ascii=FALSE)
...
saveRDS(fourgram_split_df, file="fourblogsamp_twitter_2.rds", ascii=FALSE)
...
saveRDS(bigram_split_df, file="biblogsamp_twitter_2.rds", ascii=FALSE)
...
saveRDS(unigram_count_dt, file="uniblogsamp_twitter_2.rds", ascii=FALSE)
